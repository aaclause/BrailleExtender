...
def getConfspec():
	...
	return {
		...
		"objectPresentation": {
			"propertiesOrder": 'string(default="states,cellCoordsText,value,name,roleText,description,keyboardShortcut,positionInfo,positionInfoLevel,row,columnHeaderText,column,current,placeholder")',
